...
const projects = [
  {
    ...
    tags: ['LangGraph', 'FastAPI', 'pgvector', 'React', 'Claude'],
    color: '#8B5CF6', icon: '📈', status: 'Live', year: '2026',
    links: { live: 'https://finsightagent.tech', github: 'https://github.com/phanminhtai23' },
  },
  {
    id: 2, title: 'AI Code Reviewer', subtitle: { vi: 'Công cụ lập trình', en: 'Developer Tooling' },
    description: {
      vi: 'Hệ thống review PR tự động dùng Claude để phát hiện lỗi, vấn đề bảo mật và vi phạm style. Tích hợp với GitHub Actions.',
      en: 'Automated PR review system using Claude to detect bugs, security issues, and style violations. Integrates with GitHub Actions.',
    },
    tags: ['Python', 'Claude API', 'GitHub Actions', 'FastAPI'],
    color: '#22D3EE', icon: '🔍', status: 'Open Source', year: '2026',
